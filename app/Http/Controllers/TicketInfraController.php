...
class TicketInfraController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        Activities::create([
            'role' => Auth::user()->role->name, // Assuming you have authentication
            'name' => Auth::user()->name, // Assuming you have authentication
    ...
    public function startWork($id, Request $request)
    {
        ...
        if ($request->form == 'infra') {
            return redirect()->back()->with('success', 'Work started on the ticket successfully.');
        } else {
            return redirect()->back()->with('success', 'Work started on the ticket successfully.');
        }
